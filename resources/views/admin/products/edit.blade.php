                    ...
                    <div class="mb-3">
                        ...
                        @if($product->image)
                            <div class="mt-2">
                                ...
                                <p class="text-muted mt-1"><small>Image path: {{ $product->image }}</small></p>
                            </div>
                        @endif
                    </div>
...
@section('scripts')
    <script>     // Auto-generate slug from name     document.getElementById('name').addEventListener('input', function () {         const slug = this.value             .toLowerCase()             .replace(/[^\w\s-]/g, '')             .replace(/\s+/g, '-')             .replace(/--+/g, '-');         document.getElementById('slug').value = slug;     });
    </script>
@endsection